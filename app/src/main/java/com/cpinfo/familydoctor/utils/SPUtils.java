...
public class SPUtils {
     ...
     * @param object
     */
    public void saveSerializableObject(Context context, String key, Object object) throws IOException {
     ...
     * @return
     */
    public Object getSerializableObject(Context context, String key) throws IOException, ClassNotFoundException {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
        if (sp.contains(key)) {

 ...
 * 电子病历四级页面（住院报告详情页面）
 */
public class PatientHistoryReportDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int getContentViewId() {
        return R.layout.activity_patient_history_report_detail;
    }
    ...
    protected void initTitleBar() {
        titleMiddle.setText(reportTitle);
    }
    ...
    private void getData() {
        ...
        ApiRequestManager.PatientHistoryReportDetail(reportName, mrId, new RequestCallBack<ResponseBody>() {
            @Override

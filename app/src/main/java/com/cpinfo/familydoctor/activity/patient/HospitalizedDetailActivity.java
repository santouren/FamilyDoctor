 ...
 * 住院病案详情页面
 */
public class HospitalizedDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    PDFView pdfView;
    private String hospitalizedNum;//住院编号
    ...
    protected int getContentViewId() {
        return R.layout.activity_hospitalized_detail;
    }
    ...
    protected void handleIntent(Intent intent) {
        hospitalizedNum = intent.getStringExtra("inpNo");
    }

    private void getData() {
        showLoadingPage("玩命加载中...", R.drawable.ic_loading);
        ApiRequestManager.getHospitalizedDetail(hospitalizedNum, new RequestCallBack<ResponseBody>() {
            @Override
